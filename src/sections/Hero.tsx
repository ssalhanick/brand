  ...
  return (
    <section className="hero" id="hero" aria-label="Introduction">
      ...
      <div className="container hero__inner">
        <p className="hero__eyebrow fade-in-up">
        ...
        <h1 className="hero__name fade-in-up fade-in-up--delay-1">
          ...
          <span className="hero__name-accent">
            Salhanick, <small>MS,MBA</small>
          </span>
        </h1>
        <p className="hero__tagline fade-in-up fade-in-up--delay-2">
          Over 10 years building full stack systems, APIs, and intelligent web
          experiences. Currently exploring the intersection of AI/ML and product
          engineering, with a focus on deployable rag pipelines and agentic
          systems.
        </p>
