...
const projects = [
  {
    title: "Construction Compliance Assistant",
    category: "RAG / Agentic AI",
    description:
      "Architected an end-to-end RAG platform that answers construction and home-improvement permit questions grounded in real municipal code. Resolves the governing jurisdiction stack (city, county, historic overlay) from a project address via GIS/Census geocoding rather than zip code, fans out compound questions across sub-jurisdictions with an agentic query deconstructor, and gates every answer behind citation grounding and hallucination checks. Deployed end-to-end on AWS (ECS, RDS/pgvector, Cognito) via a GitHub Actions OIDC pipeline.",
    tags: [
      "RAG",
      "Agentic AI",
      "FastAPI",
    ...
    impact:
      "CI-gated LangSmith evaluation scoring citation precision/recall and hallucination risk on every deploy",
    accent: "cream",
  },
  {
  ...
  },
  {
    ...
    impact:
      "Eliminated ~10 hrs/month of manual event entry across 30 monthly events",
    accent: "accent",
  },
  {
  ...
  },
  {
    ...
    impact:
      "Hallucination probability scoring on LLM-generated legal citations",
    accent: "cream",
  },
];
            ...
            >
              ...
              <div className="projects__card-bottom">
                ...
                <p className="projects__impact">
                  <span className="projects__impact-icon" aria-hidden="true">
                    ✦
                  </span>
                  {p.impact}
                </p>
